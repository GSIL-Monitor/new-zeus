					...
					if (context != null) {
						...
						if ("workers".equals(op)) {
							...
							for (Channel channel : workers.keySet()) {
								...
								// jdk1.8 compiler
								Set<String> runnings = new HashSet<String>();
								for(Map.Entry<String,Boolean> entry: holder.getRunnings().entrySet()){
								    runnings.add(entry.getKey()) ;
                                }
								Set<String> manualRunnings = new HashSet<String>();
                                for(Map.Entry<String,Boolean> entry: holder.getManualRunnings().entrySet()){
                                    manualRunnings.add(entry.getKey());
                                }

								Set<String> debugRunnings = new HashSet<String>();
                                for(Map.Entry<String,Boolean> entry: holder.getDebugRunnings().entrySet()){
                                    debugRunnings.add(entry.getKey());
                                }
								...
								builder.append("<br>" + "runnings:"+ JsonUtils.objectToJson(runnings));
								builder.append("<br>" + "manual runnings:"+ JsonUtils.objectToJson(manualRunnings));
								builder.append("<br>" + "debug runnings:"+ JsonUtils.objectToJson(debugRunnings));
