...
/**
 * Created by zhangxin on 18/5/2.
 */
public class EntinfoSMSClinet {
    /*
    * webservice服务器定义
    */
     ...
     * 构造函数
     */
    public EntinfoSMSClinet(String sn, String password)
    ...
    public static void main(String[] args) {
        String sn="SDK-BBX-010-27224";
        String pwd="d34-a0b)-4)";
        try{
            EntinfoSMSClinet client=new EntinfoSMSClinet(sn,pwd);
            //个性短信发送
            String result_gxmt = client.mdsmssend("18210775630", "张三您好，test1234567。[test]", "", "", "", "");
