...
public class Environment {
    ...
    private static Integer actionInterval  ;

    private static Integer maxRunningJob = Integer.valueOf(5);
    ...
    public Environment(String env,String scheduleGroup,String downloadPath,String hadoopHome,String hadoopConfDir,String hiveHome,String hiveConfDir,
		...
		try{
            Environment.actionInterval = Integer.valueOf(actionInterval.trim()) ;
        }catch(Exception e){
            Environment.actionInterval = 1 ;
            log.error("actionInterval initialize error, using default value", e);
        }

        try{
            Environment.maxRunningJob = Integer.valueOf(maxRunningJob.trim()) ;
        }catch(Exception e){
            log.error("actionInterval initialize error, using default value", e);
        }
		...
		log.info("the actionInterval is " + actionInterval.trim());
	...
	public static Integer getActionInterval() {
	    return actionInterval ;
    }

    public static Integer getMaxRunningJob(){
