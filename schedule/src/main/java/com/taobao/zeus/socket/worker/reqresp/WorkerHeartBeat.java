...
import com.taobao.zeus.util.AddressUtil;
...
public class WorkerHeartBeat {
    ...
    private static Logger log= LogManager.getLogger(WorkerHeartBeat.class);

	public static String host = UUID.randomUUID().toString();
	static {
		try {
			host = AddressUtil.getLocalInetAddress() ;
            log.info("获取到的 ip:" + host );
		} catch (Exception e) {
